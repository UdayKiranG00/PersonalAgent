  ...
  },
  {
    ...
    "parameters": {
      ...
      "properties": {
        "calendar_name": {
          "type": "string",
          "description": "The name of the specific calendar is always udayganguru2000@gmail.com."
        }
      },
  ...
  },
  {
    ...
    "parameters": {
      ...
      "properties": {
        "calendar_name": {
          "type": "string",
          "description": "The name of the calendar is always udayganguru2000@gmail.com"
        },
        "date": {
          "type": "string",
...
functionDeclarations:[
  {
    ...
    "description": "execute any command in the windows command prompt like create folders/file, read/write files etc.. in current folder.",
    "parameters": {
      "type": "object",
      "properties": {
        "command":{
